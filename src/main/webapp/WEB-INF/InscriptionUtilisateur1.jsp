        ...
        <section class="register-form">
            <form class="register">
                    ...
                    <div class="input-field">
                        ...
                        <input type="text" id="pseudo" name="pseudo" value="${utilisateur.pseudo}" size="20" required
                               maxlength="20"/>
                        <br/>
                    </div>
                    ...
                    <div class="input-field">
                        ...
                        <input type="text" id="nom" name="nom" value=""${utilisateur.nom} size="20" maxlength="60"required/>
                        <br/>
                    </div>
                    <div class="input-field">
                        <label for="prenom">Pr&eacute;nom<span class="requis">*</span></label>
                        <input type="text" id="prenom" name="prenom" value="${utilisateur.prenom}" size="20"required
                               maxlength="20"/>
                        <br/>
                    </div>
                    <div class="input-field">
                        <label for="email">Email<span class="requis">*</span></label>
                        <input type="text" id="email" name="email" value="${utilisateur.email}" size="60"
                               maxlength="50" required/>
                        <br/>
                    </div>
                    <div class="input-field">
                        <label for="telephone">T&eacute;l&eacute;phone<span class="requis">*</span></label>
                        <input type="text" id="telephone" name="telephone" value="${utilisateur.telephone}" size="15"
                               maxlength="10"required/>
                        <br/>
                    </div>
                    <div class="input-field">
                        <label for="rue">Rue <span class="requis">*</span></label>
                        <input type="text" id="rue" name="rue" value=${utilisateur.rue}" size="20" maxlength="60"required/>
                        <br/>
                    </div>
                    <div class="input-field">
                        <label for="cp">Code postal</label>
                        <input type="text" id="cp" name="cp" value="${utilisateur.cp}" size="20" maxlength="10"required/>
                        <br/>
                    </div>
                    <div class="input-field">
                        <label for="ville">Ville</label>
                        <input type="text" id="ville" name="ville" value="${utilisateur.ville}" size="30"
